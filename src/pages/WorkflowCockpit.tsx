...
export default function WorkflowCockpit() {
    ...
    // Poll for pending reviews when workflow is running
    useEffect(() => {
        ...
        const interval = setInterval(pollForReview, 3000);
        pollForReview(); // Check immediately

        return () => clearInterval(interval);
    }, [currentWorkflowId, projectId, currentPhase]);
